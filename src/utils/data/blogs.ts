...
export const blogs: IBlogs[] = [
  ...
  },
  {
    ...
    url: "JS.md",
    categoryTitle: "Web Application Programming Complete Guide - BCT - IOE",
    title: "Web Application Programming: A Complete Guide to JavaScript",
  ...
  },
  {
    ...
    url: "React.md",
    categoryTitle: "Web Application Programming Complete Guide - BCT - IOE",
    title: "Web Application Programming: A Complete Guide to React.js",
    shortTitle: "Unit 2: React.js",
    slug: "web-application-programming-complete-guide",
    github: "https://github.com/bidursapkota00/web-application-programming-bct",
    categoryDescription:
      "Learn basics of web application programming with html, css, javascript, react, django, rest apis, security measures, deployment, and more.",
  ...
  },
  {
    ...
    url: "security.md",
    categoryTitle: "Web Application Programming Complete Guide - BCT - IOE",
    title: "Web Application Programming: Web Application Security with Django",
    shortTitle: "Unit 5: Security",
    slug: "web-application-programming-complete-guide",
    github: "https://github.com/bidursapkota00/web-application-programming-bct",
    categoryDescription:
      "Learn basics of web application programming with html, css, javascript, react, django, rest apis, security measures, deployment, and more.",
    description:
      "Comprehensive, developer-focused guide covering common vulnerabilities (XSS, SQL injection, CSRF), secure coding and deployment practices, authentication/session management, HTTPS and cookie hardening, CORS/CSP, JWT/refresh token strategies, and concrete Django examples.",
    categoryDisplayTitle: "Web App Programming",
    categoryImage: "/images/11-web-application-programming.webp",
    categorySubTitle: "Web Application Programming",
    image: "/images/16-web-app-security-700.webp",
    category: ["HTML", "CSS", "JavaScript", "React", "Python", "Django"],
